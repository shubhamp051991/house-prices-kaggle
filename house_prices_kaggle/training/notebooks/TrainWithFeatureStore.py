...
# ``house_prices_kaggle/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-house-prices-kaggle-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.models.house-prices-kaggle-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.models.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.models.trip_dropoff_features",
