...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``house_prices_kaggle/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in house-prices-kaggle/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in house-prices-kaggle/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-house-prices-kaggle-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.models.house-prices-kaggle-model", "Full (Three-Level) Model Name")
