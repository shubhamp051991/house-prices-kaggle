...
git add README.md docs .gitignore house_prices_kaggle/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[house-prices-kaggle/databricks.yml](../house_prices_kaggle/databricks.yml) file.
...
Follow the instructions in [house-prices-kaggle/resources/README.md](../house_prices_kaggle/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../house_prices_kaggle/resources/README.md)  to propose, test, and deploy
